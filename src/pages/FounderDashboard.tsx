  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const q = query(applicationsRef, where("recruiterId", "==", uid));
        ...
        const candidatesData = await Promise.all(
          applicationsSnap.docs.map(async (appDoc) => {
            ...
            if (!developerData) {
              console.warn(
                `Developer data not found for ID: ${appData.developerId}`
              );
              return null;
            }
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-gray-50/80">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        Company Size: {profile.companySize} employees
                      </p>
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-gray-50/80">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-2">
                        Experience: {profile.experienceRequired} years
                      </p>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {filteredCandidates.length === 0 && (
                      ...
                      >
                        <p className="text-gray-500">
                          No developers found in {activeTab} status.
                        </p>
                      </motion.div>
                    )}
                  </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditedProfile((prev) =>
                      prev ? { ...prev, companySize: e.target.value } : null
                    )
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditedProfile((prev) =>
                      prev ? { ...prev, fundingStage: e.target.value } : null
                    )
                  }
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditedProfile((prev) =>
                      prev ? { ...prev, equityRange: e.target.value } : null
                    )
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditedProfile((prev) =>
                      prev ? { ...prev, salaryRange: e.target.value } : null
                    )
                  }
                />
              </div>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setEditedProfile((prev) =>
                    prev ? { ...prev, roleDescription: e.target.value } : null
                  )
                }
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setEditedProfile((prev) =>
                    prev ? { ...prev, techStack: e.target.value } : null
                  )
                }
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setEditedProfile((prev) =>
                    prev
                      ? { ...prev, experienceRequired: e.target.value }
                      : null
                  )
                }
              />
              ...
              <CardContent className="p-6 space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setIdeaPost((prev) =>
                        prev ? { ...prev, cofounderRole: e.target.value } : null
                      )
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setIdeaPost((prev) =>
                        prev
                          ? { ...prev, ideaDescription: e.target.value }
                          : null
                      )
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setIdeaPost((prev) =>
                        prev
                          ? { ...prev, responsibilities: e.target.value }
                          : null
                      )
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setIdeaPost((prev) =>
                        prev
                          ? { ...prev, idealCandidate: e.target.value }
                          : null
                      )
                    }
            ...
            <div className="space-y-6">
                ...
                <div>
                  ...
                  {selectedCandidate.whatsappNumber && (
                    <p className="text-gray-500 flex items-center space-x-2">
                      ...
                      <a
                        href={`https://wa.me/${selectedCandidate.whatsappNumber.replace(
                          /\+/g,
                          ""
                        )}`}
                        target="_blank"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p>
                    {selectedCandidate.degree} at {selectedCandidate.university}
                  </p>
              ...
              {selectedCandidate.github && (
                <div>
                  ...
                  <a
                    href={`https://github.com/${selectedCandidate.github}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 hover:underline"
                  >
